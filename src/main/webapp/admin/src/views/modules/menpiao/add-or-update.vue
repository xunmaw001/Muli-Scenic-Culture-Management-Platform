<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景点" prop="jingdian">
          <el-input v-model="ruleForm.jingdian" 
              placeholder="景点" clearable  :readonly="ro.jingdian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景点" prop="jingdian">
              <el-input v-model="ruleForm.jingdian" 
                placeholder="景点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参观时间" prop="canguanshijian">
          <el-input v-model="ruleForm.canguanshijian" 
              placeholder="参观时间" clearable  :readonly="ro.canguanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参观时间" prop="canguanshijian">
              <el-input v-model="ruleForm.canguanshijian" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingqumingcheng = true;
          ...
          if(o=='jingdian'){
            this.ruleForm.jingdian = obj[o];
	    this.ro.jingdian = true;
            continue;
          }
          if(o=='renshu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `menpiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.menpiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
