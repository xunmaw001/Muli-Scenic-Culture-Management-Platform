      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店铺编号" prop="dianpubianhao">
          <el-input v-model="ruleForm.dianpubianhao" 
              placeholder="店铺编号" clearable  :readonly="ro.dianpubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店铺编号" prop="dianpubianhao">
              <el-input v-model="ruleForm.dianpubianhao" 
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jingqushangpin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jingqushangpinCrossAddOrUpdateFlag = false;
						 this.parent.search();
