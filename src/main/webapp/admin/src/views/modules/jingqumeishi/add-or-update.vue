<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商铺位置" prop="shangpuweizhi">
          <el-input v-model="ruleForm.shangpuweizhi" 
              placeholder="商铺位置" clearable  :readonly="ro.shangpuweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商铺位置" prop="shangpuweizhi">
              <el-input v-model="ruleForm.shangpuweizhi" 
                placeholder="商铺位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpumingcheng = true;
          ...
          if(o=='shangpuweizhi'){
            this.ruleForm.shangpuweizhi = obj[o];
	    this.ro.shangpuweizhi = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jingqumeishi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jingqumeishiCrossAddOrUpdateFlag = false;
						 this.parent.search();
