<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景区名称" prop="jingqumingcheng">
          <el-input v-model="ruleForm.jingqumingcheng" 
              placeholder="景区名称" clearable  :readonly="ro.jingqumingcheng"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="沿途商铺" prop="yantushangpu">
          <el-input v-model="ruleForm.yantushangpu" 
              placeholder="沿途商铺" clearable  :readonly="ro.yantushangpu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="沿途商铺" prop="yantushangpu">
              <el-input v-model="ruleForm.yantushangpu" 
                placeholder="沿途商铺" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="景区简介" prop="jingqujianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingqujianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingqujianjie" label="景区简介" prop="jingqujianjie">
                    <span v-html="ruleForm.jingqujianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="特色美食" prop="tesemeishi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tesemeishi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tesemeishi" label="特色美食" prop="tesemeishi">
                    <span v-html="ruleForm.tesemeishi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="旅游交通工具" prop="lvyoujiaotonggongju">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.lvyoujiaotonggongju" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lvyoujiaotonggongju" label="旅游交通工具" prop="lvyoujiaotonggongju">
                    <span v-html="ruleForm.lvyoujiaotonggongju"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='jingqujianjie'){
            this.ruleForm.jingqujianjie = obj[o];
	    this.ro.jingqujianjie = true;
            continue;
          }
          if(o=='yantushangpu'){
            this.ruleForm.yantushangpu = obj[o];
	    this.ro.yantushangpu = true;
            continue;
          }
          if(o=='tesemeishi'){
            this.ruleForm.tesemeishi = obj[o];
	    this.ro.tesemeishi = true;
            continue;
          }
          if(o=='lvyoujiaotonggongju'){
            this.ruleForm.lvyoujiaotonggongju = obj[o];
	    this.ro.lvyoujiaotonggongju = true;
            continue;
          }
          if(o=='shijian'){
	...
	this.ruleForm.jingqujianjie = this.ruleForm.jingqujianjie.replace(reg,'../../../ssmd4uh5/upload');
	this.ruleForm.tesemeishi = this.ruleForm.tesemeishi.replace(reg,'../../../ssmd4uh5/upload');
	this.ruleForm.lvyoujiaotonggongju = this.ruleForm.lvyoujiaotonggongju.replace(reg,'../../../ssmd4uh5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jingqu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jingquCrossAddOrUpdateFlag = false;
						 this.parent.search();
